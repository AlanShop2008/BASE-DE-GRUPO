...
import { sendFakeBusiness as sendFakeBusinessHelper } from './sendFakeBusiness.js'
...
async value(jid, medias, options = {}) {
  ...
  return album
     ...
     sendNyanCat: {
        ...
        sendFakeBusiness: {
            async value(jid, text = '', imagePath = './storage/img/catalogo.png', quoted, options = {}) {
                return sendFakeBusinessHelper(conn, jid, text, imagePath, quoted, options)
            },
            enumerable: true,
        },
        sendPayment: {
